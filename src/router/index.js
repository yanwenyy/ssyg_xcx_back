...
const mainRoutes = {
  ...
  children: [
    ...
    {path:'/policy-evaluation',
      component:_import('modules/policy/policy-evaluation'),
      name:'policy-evaluation',
      meta:{title:'测评',isTab: true },
    },
    {path:'/policy-question-add-or-update',
      component:_import('modules/policy/policy-question-add-or-update'),
      name:'policy-question-add-or-update',
      meta:{title:'测评试题',isTab: true },
    },
    {path:'/policy-question-view',
      component:_import('modules/policy/policy-question-view'),
      name:'policy-question-view',
      meta:{title:'测评试题查看',isTab: true },
    },
